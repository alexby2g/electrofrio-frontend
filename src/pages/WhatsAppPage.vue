    ...
    <div class="row q-col-gutter-lg">
      <div class="col-12 col-lg-7">
        <q-card class="panel-card">
          <q-card-section class="row items-center justify-between q-col-gutter-md">
            <div class="col">
              ...
              <div class="text-body2 text-grey-7">
                Usa el flujo seguro de Meta para autorizar la cuenta de WhatsApp Business.
              </div>
            </div>
          ...
          <q-card-section>
            <q-banner v-if="lastError" rounded class="bg-red-1 text-red-9 q-mb-md">
              <template #avatar>
            ...
            >
              ...
              Meta autorizó la cuenta, pero falta guardar la conexión en el backend.
            </q-banner>

            <div class="connection-box q-mb-lg">
              <q-avatar size="74px" color="green-1" text-color="green-8" icon="phone_in_talk" />

              <div class="connection-copy">
                <div class="text-h6 text-weight-bold">Electro Frío</div>
                <div class="text-body2 text-grey-7">
                  Configuración de coexistencia con la aplicación WhatsApp Business.
                </div>
              </div>
            </div>
            ...
            <div v-if="!sdkReady" class="text-caption text-grey-7 text-center q-mt-sm">
      ...
      <div class="col-12 col-lg-5">
        <q-card class="panel-card details-card">
          <q-card-section>
            <div class="text-h6 text-weight-bold q-mb-md">Datos de la integración</div>
            ...
            <q-list separator>
              ...
              <q-item v-if="sessionInfo.phoneNumberId">
                ...
                <q-item-section>
                  ...
                  <q-item-label caption>{{ sessionInfo.phoneNumberId }}</q-item-label>
                </q-item-section>
              </q-item>
            </q-list>
          </q-card-section>
...
const META_CONFIG_ID = import.meta.env.QCLI_META_CONFIG_ID || '2323988618137582'
const META_GRAPH_VERSION = import.meta.env.QCLI_META_GRAPH_VERSION || 'v26.0'
const CONNECT_PATH = import.meta.env.QCLI_WHATSAPP_CONNECT_PATH || '/whatsapp/embedded-signup'
const STATUS_PATH = import.meta.env.QCLI_WHATSAPP_STATUS_PATH || '/whatsapp/status'
...
function loadFacebookSdk() {
  ...
  facebookSdkPromise = new Promise((resolve, reject) => {
    ...
    if (existingScript) {
      existingScript.addEventListener('error', () => reject(new Error('No se pudo cargar Meta SDK.')), {
        once: true
      })
      return
    }
  ...
  methods: {
    async loadConnectionStatus() {
      try {
        ...
        // El endpoint se agregará en el backend. Un 404 no debe romper esta pantalla.
      }
    },
    ...
    handleEmbeddedSignupMessage(event) {
      ...
      if (payload.event === 'ERROR') {
        ...
        this.connecting = false
        this.status = 'error'
        this.lastError = data.error_message || data.message || 'Meta informó un error durante la conexión.'
      }
    },
    ...
    async connectWhatsApp() {
      ...
      try {
        ...
        FB.login(
          response => {
            ...
            if (!code) {
              ...
              this.$q.notify({
                type: 'warning',
                message: 'Meta no devolvió la autorización. Revisa si cerraste la ventana o cancelaste el proceso.'
              })
              return
            }
        ...
        this.connecting = false
        this.status = 'error'
        this.lastError = error.message || 'No se pudo iniciar la conexión con Meta.'
      }
    },
    ...
    async saveConnection() {
      ...
      try {
        ...
        this.sessionInfo = {
          ...
          phoneNumberId: data.phone_number_id || data.phoneNumberId || this.sessionInfo.phoneNumberId,
          businessId: data.business_id || data.businessId || this.sessionInfo.businessId
        }
        ...
        this.$q.notify({
          type: 'warning',
          message: 'La autorización llegó correctamente. Falta completar la conexión en el backend.'
        })
      } finally {
        this.authorizationCode = null
        this.connecting = false
